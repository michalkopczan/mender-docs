...
We recommend to use the Raspberry Pi Imager tool, choose "Use custom" and
...
After you select custom mender image to flash and click "Next", edit your settings:
...
Flash the image direclty after choosing it in Raspberry Pi Imager tool, without doing any
configuration.
